...
public:
	...
	struct Battle : MonoBehaviour {
		void *MainCamera(void* point){
            return *(void**)((uintptr_t)point + Il2CppGetFieldOffset(OBFUSCATE("Assembly-CSharp.dll"), OBFUSCATE(""), OBFUSCATE("Battle"), OBFUSCATE("MainCamera")));
        }
	};
};
